...
2026-01-28T07:58:18.030Z is the date. Write a haiku about it.
...
<env>
Working directory: /private/var/folders/y2/ph4wxddj7_10b_vt67r8v_v80000gn/T/claude-history-1769587096741-1l7vl2
...
mcp__posthog__dashboard-reorder-tiles
...
<description>
Query project learnings for relevant past experiments, failure patterns, and working configurations before starting work. Use at the beginning of a task, when stuck on a problem, or when you want to check if something has been tried before. (user)
</description>
<location>
user
</location>
...
<description>
Extract user preferences, rules, and corrections from the session and save them to CLAUDE.md with full observability. Use when the user shares preferences, corrections, or rules they want you to remember. (user)
</description>
<location>
user
</location>
...
<description>
Commit and push changes to the current branch (user)
</description>
<location>
user
</location>
...
<description>
Commit, push, and open a pull request. Shortcut for /commit-commands:commit-push-pr (user)
</description>
<location>
user
</location>
...
<description>
Create distinctive, production-grade frontend interfaces with high design quality. Use this skill when the user asks to build web components, pages, or applications. Generates creative, polished code that avoids generic AI aesthetics. (user)
</description>
<location>
user
</location>
...
<description>
Generate any image - icons, assets, illustrations, app icons. Specify what you need, output path, and whether transparency is required. (user)
</description>
<location>
user
</location>
...
<description>
Write clear UI copy for mobile apps. Use when writing buttons, errors, empty states, permissions, onboarding, paywalls, or reviewing existing app text. (user)
</description>
<location>
user
</location>
...
<description>
Orchestrate child Claude sessions to implement complex multi-step plans. Use when you want to delegate focused tasks to separate Claude instances to save context window and maintain clean separation of concerns. (user)
</description>
<location>
user
</location>
...
<description>
Generate images from text OR edit existing images using image prompting (input image + text). Uses Google Gemini API. Supports multiple input images for style transfer. (user)
</description>
<location>
user
</location>
...
<description>
Write high-converting paywall copy for mobile subscription apps. Use when writing paywall text, CTA buttons, trial messaging, pricing copy, or reviewing existing paywall copy. Based on research from Superwall, RevenueCat, Apphud, and Purchasely. (user)
</description>
<location>
user
</location>
...
<description>
Create high-level implementation plans for complex features requiring multiple agent sessions (user)
</description>
<location>
user
</location>
...
<description>
Extract learnings from the current session and append them to the project learnings file. Use at the end of a work session, after completing a task, or when you've discovered something important (a failure, a success, a workaround, or a pattern). (user)
</description>
<location>
user
</location>
...
<description>
Get the current Claude Code session ID from history (user)
</description>
<location>
user
</location>
...
<description>
Guide users through creating Agent Skills for Claude Code. Use when the user wants to create, write, author, or design a new Skill, or needs help with SKILL.md files, frontmatter, or skill structure. (user)
</description>
<location>
user
</location>
...
<description>
Creates a detailed handoff plan of the conversation for continuing the work in a new session. (user)
</description>
<location>
user
</location>
...
<description>
Resumes work from a previous handoff session which are stored in `.claude/handoffs`. (user)
</description>
<location>
user
</location>
...
<description>
Cleans up all git branches marked as [gone] (branches that have been deleted on the remote but still exist locally), including removing associated worktrees. (plugin:commit-commands@claude-plugins-official)
</description>
<location>
plugin
</location>
...
<description>
Commit, push, and open a PR (plugin:commit-commands@claude-plugins-official)
</description>
<location>
plugin
</location>
...
<description>
Create a git commit (plugin:commit-commands@claude-plugins-official)
</description>
<location>
plugin
</location>
...
<description>
Cancel active Ralph Loop (plugin:ralph-loop@claude-plugins-official)
</description>
<location>
plugin
</location>
...
<description>
Explain Ralph Loop plugin and available commands (plugin:ralph-loop@claude-plugins-official)
</description>
<location>
plugin
</location>
...
<description>
Start Ralph Loop in current session (plugin:ralph-loop@claude-plugins-official)
</description>
<location>
plugin
</location>
...
<description>
Code review a pull request (plugin:code-review@claude-plugins-official)
</description>
<location>
plugin
</location>
